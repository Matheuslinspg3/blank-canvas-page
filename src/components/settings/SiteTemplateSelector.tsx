...
const templates: TemplateOption[] = [
  {
    id: "classic",
    name: "Clássico",
    description: "Gradiente no hero, cards com sombra, layout centralizado",
    icon: Layout,
  ...
  },
  {
    id: "modern",
    name: "Moderno",
    description: "Hero escuro, cards arredondados, seções alternadas",
    icon: Columns3,
  ...
  },
  {
    id: "elegant",
    name: "Elegante",
    description: "Tipografia serif, bordas finas, estilo sofisticado",
    icon: Diamond,
  ...
  },
  {
    id: "bold",
    name: "Impactante",
    description: "Cor vibrante, texto grande, formas geométricas",
    icon: Zap,
  ...
  },
  {
    id: "minimal",
    name: "Minimalista",
    description: "Fundo branco, sem gradientes, espaçamento generoso",
    icon: Minus,
