-- Drop ALL overloads of search_properties_advanced to start clean
DROP FUNCTION IF EXISTS public.search_properties_advanced(uuid, text, text, text, text, uuid, numeric, numeric, integer, text, text, numeric, integer, integer);

DROP FUNCTION IF EXISTS public.search_properties_advanced(uuid, text, text, text, text, uuid, numeric, numeric, integer, text, text, numeric, integer, integer, integer, integer, numeric, numeric, numeric, text[], text, integer, text);

DROP FUNCTION IF EXISTS public.search_properties_advanced(uuid, text, text, text, text, uuid, numeric, numeric, integer, text, text, numeric, integer, integer, integer, integer, numeric, numeric, numeric, text[], text, integer, text, text[], text[]);
...
RETURNS TABLE(
  ...
  property_type_id uuid, cover_image_url text, beach_distance_meters integer,
